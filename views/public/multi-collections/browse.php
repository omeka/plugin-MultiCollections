...
<div id="primary">
    ...
    <div class="collection">
        ...
        <p class="view-items-link"><?php echo multicollections_link_to_items_browse(__('View the items in %s', metadata('collection', array('Dublin Core', 'Title'))), array('collection' => metadata('collection', 'id'))); ?></p>
